...
| [pi-quiet-spinner](./packages/pi-quiet-spinner) | [`pi-quiet-spinner`](https://www.npmjs.com/package/pi-quiet-spinner) | Floors pi-tui spinner frame intervals to cut the CPU cost of full-transcript redraws. |
